    ...
    return(
        <div>
            ...
            <div className="cont-gal">
                ...
                <ul className="slider">
                  <li id = 'slider1'>
                      <img className="gal-imagen" src={gal? gal[0]: logo}/>
                  </li>
                  <li id = 'slider2'>
                      <img className="gal-imagen" src={gal? gal[1]: logo}/>
                  </li>
                  <li id = 'slider3'>
                      <img className="gal-imagen" src={gal? gal[2]: logo}/>  
                  </li>
                  <li id = 'slider4'>
                      <img className="gal-imagen" src={gal? gal[3]: logo}/>
                  </li>
                  <li id = 'slider5'>
                      <img className="gal-imagen" src={gal? gal[4]: logo}/>
                  </li>
                </ul>
